...
{
    public class CameraExt : INotifyPropertyChanged
    {
        ...
        public CameraExt(Camera camera)  {
            _camera = camera;
        ...
        public Boolean HasPTZ { get => _hasPTZ; set { if (_hasPTZ != value) { _hasPTZ = value; RaisePropertyChanged(nameof(HasPTZ)); } } }
        [Display(Name = "Hat Zoom")]
        public Boolean HasZoom { get => _hasZoom; set { if (_hasZoom != value) { _hasZoom = value; RaisePropertyChanged(nameof(HasZoom)); } } }

        [Display(Name = "IP Adresse")]
        [IPAddressAttribute]
        public string IpAdress { get => _ipAdress; set { if (_ipAdress != value) { _ipAdress = value; RaisePropertyChanged(nameof(IpAdress)); RaisePropertyChanged(nameof(RTSPFirstURL)); RaisePropertyChanged(nameof(RTSPSecondURL)); } } }
        [Display(Name = "Port Konfiguration")]
        public int PortConfig { get => _portConfig; set { if (_portConfig != value) { _portConfig = value; RaisePropertyChanged(nameof(PortConfig)); } } }
        [Display(Name = "Port Hauptstream")]
        public int PortFirstStream { get => _portFirstStream; set { if (_portFirstStream != value) { _portFirstStream = value; RaisePropertyChanged(nameof(PortFirstStream)); RaisePropertyChanged(nameof(RTSPFirstURL)); } } }
        [Display(Name = "Protokoll Hauptstream")]
        [RegularExpression(@"^(http|rtsp)")]
        public string? ProtokollFirstStream { get => _protokollFirstStream; set { if (_protokollFirstStream != value) { _protokollFirstStream = value; RaisePropertyChanged(nameof(ProtokollFirstStream)); RaisePropertyChanged(nameof(RTSPFirstURL)); } } }
        [Display(Name = "Pfad Hauptstream")]
        public string? PathFirstStream { get => _pathFirstStream; set { if (_pathFirstStream != value) { _pathFirstStream = value; RaisePropertyChanged(nameof(PathFirstStream)); RaisePropertyChanged(nameof(RTSPFirstURL)); } } }
        [Display(Name = "Port Nebenstream")]
        public int PortSecondStream { get => _portSecondStream; set { if (_portSecondStream != value) { _portSecondStream = value; RaisePropertyChanged(nameof(PortSecondStream)); RaisePropertyChanged(nameof(RTSPSecondURL)); } } }
        ...
        public string? ProtokollSecondStream { get => _protokollSecondStream; set { if (_protokollSecondStream != value) { _protokollSecondStream = value; RaisePropertyChanged(nameof(ProtokollSecondStream)); RaisePropertyChanged(nameof(RTSPSecondURL)); } } }
        [Display(Name = "Pfad Nebenstream")]
        public string? PathSecondStream { get => _pathSecondStream; set { if (_pathSecondStream != value) { _pathSecondStream = value; RaisePropertyChanged(nameof(PathSecondStream)); RaisePropertyChanged(nameof(RTSPSecondURL)); } } }

       
        public string? RTSPFirstURL { get { return Path.Combine(string.Format("{0}://{1}:{2}@{3}:{4}/", ProtokollFirstStream, _camera.UserName, _camera.Password, IpAdress, PortFirstStream), PathFirstStream ?? ""); } }
        public string? RTSPSecondURL { get { return Path.Combine(string.Format("{0}://{1}:{2}@{3}:{4}/", ProtokollSecondStream, _camera.UserName, _camera.Password, IpAdress, PortSecondStream), PathSecondStream ?? ""); } }
